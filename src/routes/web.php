...
Route::middleware(['auth', 'verified'])->group(function () {
	...
	Route::post('/attendance/clock-in', [UserAttendanceController::class, 'clockIn'])->name('attendance.clock_in');
	...
	Route::post('/attendance/clock-out', [UserAttendanceController::class, 'clockOut'])->name('attendance.clock_out');
	...
	Route::post('/attendance/detail/{id}/request', [UserStampCorrectionRequestController::class, 'store'])
...
Route::middleware(['auth'])->group(function () {
	Route::get('/stamp_correction_request/list', function () {
		...
		return app(UserStampCorrectionRequestController::class)->indexForUser();
...
Route::prefix('admin')->name('admin.')->group(function () {
	...
	Route::middleware(['auth', 'can:is-admin'])->group(function () {
		...
		Route::get('/attendance/staff/{id}', [StaffAttendanceController::class, 'index'])->name('attendance.staff');
		Route::get('/attendance/staff/{id}/csv', [StaffAttendanceCsvController::class, 'download'])->name('attendance.staff.csv');
	});
});
